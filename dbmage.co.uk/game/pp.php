...
define('LOGOUT_URL', 'http://dbmage.co.uk/game/');
...
include("forgot.php");
} elseif(!function_exists('showLoginPasswordProtect')) {
...
<?php if (USE_USERNAME) echo 'Login:<br /><input type="input" name="access_login" /><br />Password:<br />'; ?>
  ...
  <br />
  <a href="?register='yes'">Create account</a>&nbsp&nbsp&nbsp&nbsp<a href="?forgot='yes'">Forgot your password?</a><br>
